...
"""
The class entertainment_center (Entertainment Center) defines a list of movie objects and their attributes.
...
wind = media.Movie("Gone with the Wind",
                   "Epic Civil War drama focuses on the life of petulant southern belle Scarlett O'Hara. Starting with her idyllic on a sprawling plantation, the film traces her survival through the tragic history of the South during the Civil War and Reconstruction.",
...
sunshine = media.Movie("Eternal Sunshine of the Spotless Mind",
                   "Relationships are built from memories both good and bad.Erasing them proves difficult",
